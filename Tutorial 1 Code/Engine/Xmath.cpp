...
void XMath::inversepro(const MATRIX4X4 & M1, MATRIX4X4 & M2)
{
	...
	M2.M[0][0] = a; M2.M[0][1] = 0; M2.M[0][2] = 0; M2.M[0][3] = 0;
	M2.M[1][0] = 0; M2.M[1][1] = b; M2.M[1][2] = 0; M2.M[1][3] = 0;
	M2.M[2][0] = 0; M2.M[2][1] = 0; M2.M[2][2] = 0; M2.M[2][3] = c;
	//M2.M[3][0] = d; M2.M[3][1] = e; M2.M[3][2] = 1; M2.M[3][3] = f;
	M2.M[3][0] = 0; M2.M[3][1] = 0; M2.M[3][2] = 1; M2.M[3][3] = f;
...
void XMath::inversemcar(const MATRIX4X4 & M1, MATRIX4X4 & M2)
{
	...
	M2.M[1][0] = 0; M2.M[1][1] = b; M2.M[1][2] = 0; M2.M[1][3] = 0;
	M2.M[2][0] = 0; M2.M[2][1] = 0; M2.M[2][2] = 1; M2.M[2][3] = 0;
	M2.M[3][0] = -1; M2.M[3][1] = 1; M2.M[3][2] = 0; M2.M[3][3] = 1;
